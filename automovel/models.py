...
class Automovel(models.Model):
    ...
    dono = models.CharField('Dono', max_length=15)
    ...
    co = models.CharField('CO', max_length=15)
    ...
    cartrack = models.CharField('Cartrack', max_length=8, blank=True, null=True)
    ...
    combustivel = models.CharField('Combustivel', max_length=10)
    ...
    contrato = models.CharField('Contrato', max_length=20, blank=True, null=True)
    financeira = models.CharField('Financeira', max_length=15, blank=True, null=True)
    obs = models.PositiveIntegerField('Observação', blank=True, null=True)
    banco_de_pagamento = models.CharField('Banco de pagamento', max_length=15, blank=True, null=True)
    dia_prestacao = models.PositiveIntegerField('Dia de prestação', blank=True, null=True)
    seguro = models.CharField('Seguro', max_length=10, blank=True, null=True)
