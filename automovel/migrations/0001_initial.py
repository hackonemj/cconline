    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peso_bruto', models.DecimalField(blank=True, decimal_places=3, max_digits=12, null=True, verbose_name='Peso bruto')),
                ('cc', models.DecimalField(blank=True, decimal_places=3, max_digits=12, null=True, verbose_name='CC')),
                ...
                ('contrato', models.CharField(blank=True, max_length=20, null=True, verbose_name='Contrato')),
